...
public class FlavorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor){
        ...
        int versionIndex = cursor.getColumnIndex(MotivatorContract.FlavorEntry.COLUMN_VERSION_NAME);
        final String versionName = cursor.getString(versionIndex);
        viewHolder.textView.setText(versionName);

        int imageIndex = cursor.getColumnIndex(MotivatorContract.FlavorEntry.COLUMN_ICON);
